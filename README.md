...
> [!IMPORTANT]
> If you recieve the message "ECU not found..." make sure the ECU is running for at least 10 minutes after a restart because it might still be in recovery state (inverter data was not yet received). I'm working on a fix for that.
